...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Inscription Étudiant') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('student.register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="access_code" class="col-md-4 col-form-label text-md-end">{{ __('Code d\'accès') }}</label>
                            <div class="col-md-6">
                                <input id="access_code" type="text" class="form-control @error('access_code') is-invalid @enderror" name="access_code" value="{{ old('access_code', request()->query('code')) }}" required autocomplete="access_code" autofocus>
                                @error('access_code')
