<!-- resources/views/student/library/recommended.blade.php -->

@extends('layouts.student')

@section('content')
<div class="container">
    <h1>{{ __('Recommended Books') }}</h1>

    <div class="row mb-3">
        <div class="col-md-12">
            <form action="{{ route('student.library.recommended') }}" method="GET" class="form-inline">
            ...
            <ul class="list-group">
                @foreach($categories as $category)
                    <li class="list-group-item">
                        <a href="{{ route('student.library.index', $category->slug) }}">{{ $category->name }}</a>
                    </li>
                @endforeach
            </ul>
        </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('student.book.show', $book->slug) }}" class="btn btn-primary">{{ __('View Book') }}</a>
                            </div>
                        </div>
                    </div>
                @endforeach
