...
<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            <label for="published_at" class="form-label">{{ __('Publié le (Optionnel)') }}</label>
            ...
            <small class="form-text text-muted">{{ __("Laisser vide pour publier immédiatement.") }}</small>
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            <label for="expires_at" class="form-label">{{ __('Expire le (Optionnel)') }}</label>
            ...
            <small class="form-text text-muted">{{ __("Laisser vide pour que l'annonce n'expire jamais.") }}</small>
        </div>
    </div>
</div>
