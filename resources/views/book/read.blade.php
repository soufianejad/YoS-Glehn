                        ...
                        <div id="pdf-controls" class="mt-3 d-flex flex-column flex-md-row justify-content-between align-items-center gap-2 bg-light p-3 rounded shadow-sm">
                            ...
                            <div class="text-center flex-grow-1">
                                <div class="fw-bold small">
                                    {{ __('Page') }} <span id="page-num">1</span> / <span id="page-count">0</span>
                                </div>
                            ...
                            <div class="d-flex gap-2 flex-wrap justify-content-center">
                                <button id="toggle-bookmarks" class="btn btn-outline-info btn-sm" title="{{ __('Marque-pages') }}"><i class="bi bi-bookmarks"></i></button>
                                <button id="add-bookmark"     class="btn btn-outline-success btn-sm" title="{{ __('Ajouter un marque-page') }}"><i class="bi bi-bookmark-plus"></i></button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="bookmark-form">
                        ...
                        <p class="text-muted small">{{ __('Page') }} : <span id="bookmark-page-number"></span></p>
                    </form>
                </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const pdfUrl = "{{ route('read.pdf.content', $book) }}?file_id={{ $fileId }}";
        ...
        list.forEach(bm => {
            ...
            item.innerHTML = `
                <div class="flex-grow-1" style="cursor:pointer">
                    ...
                    <small class="text-muted">{{ __('Page') }} ${bm.page_number}</small>
                </div>
                <div>
