                    ...
                    <div class="card-body">
                         <div class="mb-3">
                            <label for="cover_image" class="form-label">{{ __('Image de Couverture') }}</label>
                             @if($book->cover_image) <img src="{{ asset('storage/' . $book->cover_image) }}" alt="{{ __('Current Cover') }}" class="img-thumbnail mb-2" width="150"> @endif
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                ...
                                <option value="pending" {{ old('status', $book->status) == 'pending' ? 'selected' : '' }}>{{ __('Soumettre pour validation') }}</option>
                            ...
                            <small class="form-text text-muted">Le statut 'Publié' ne peut être assigné que par un administrateur.</small>
