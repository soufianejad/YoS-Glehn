                        ...
                        <form action="{{ route('admin.settings.languages.update') }}" method="POST">
                            ...
                            <div class="row align-items-end">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('language_code') is-invalid @enderror" id="language_code" name="language_code" placeholder="ex: fr, en, sw" required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('language_name') is-invalid @enderror" id="language_name" name="language_name" placeholder="ex: Français, English, Swahili" required>
