...
@section('title', __('Paiement') . ' - ' . $plan->name)
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-5 bg-light p-4 p-md-5">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <span>{{ __('Type') }}</span>
                            <span class="fw-bold text-uppercase">{{ $type === 'renewal' ? __('Renouvellement') : __('Nouvel Abonnement') }}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span>{{ __('Durée') }}</span>
                            <span class="fw-bold">{{ $plan->duration_days }} {{ __('jours') }}</span>
                        </div>
                        ...
                        <div class="alert alert-info border-0 rounded-3 small">
                            ...
                            {{ __('Votre abonnement sera activé immédiatement après la confirmation du paiement.') }}
                        </div>
                    </div>
