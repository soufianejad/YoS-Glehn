...
<div class="pricing-header text-center">
    <div class="container">
        <h1 class="display-4 font-weight-bold">{{ __('Choisissez Votre Plan') }}</h1>
        <p class="lead text-muted">{{ __('Accès illimité à une bibliothèque riche et inspirante. Annulez à tout moment.') }}</p>
    </div>
</div>
