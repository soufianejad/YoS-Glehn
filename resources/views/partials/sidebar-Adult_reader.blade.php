<ul class="list-unstyled components">
    ...
    <li class="mt-1">
        <a href="#accountSubmenu"
           data-bs-toggle="collapse"
           aria-expanded="{{ request()->routeIs('adult.profile') || request()->routeIs('subscription.index') || request()->routeIs('reader.payments') ? 'true' : 'false' }}"
           class="dropdown-toggle nav-link sidebar-heading text-decoration-none">
            {{ __('Mon Compte') }}
        </a>
        <ul class="p-0 collapse {{ request()->routeIs('adult.profile') || request()->routeIs('subscription.index') || request()->routeIs('reader.payments') ? 'show' : '' }}" id="accountSubmenu">
